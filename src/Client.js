 ...
 * @param {10000} options.qrRefreshIntervalMs - Refresh interval for qr code (how much time to wait before checking if the qr code has changed)
 * @param {100000} options.qrTimeoutMs - Timeout for qr code selector in puppeteer
